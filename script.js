...
const groupMapping = {
    "Facilitador": [
        "LOPEZ ESTRADA MIGUEL JOSE", "RAMIREZ MONSERRAT,MARTIN ALEJANDRO", "PATIÑO NEIRA CLARA DEL PILAR", 
        "FANDIÑO RODRIGUEZ,DEIBY ALEXANDER", "BARON VASQUEZ,DIEGO FERNANDO"
    ],
    "1": [
        "GRILLO MARTINEZ,JUAN JOSE", "RUBIO GIRON,KAROL TATIANA", "CONTRERAS MARTINEZ,WILBER ENRIQUE", 
        "ADAMES PRADA,GABRIEL ARTURO", "PERDOMO QUEVEDO,DIANA PAOLA"
    ],
    "2": [
        "GARCIA ARIZA,JOHN PEDRO", "BLANCO SAYAGO,EDINSON JAVIER", "ROA PUENTES,HENRY YAMIL", 
        "ANGARITA AGUDELO,LAURA LORENA", "SANDOVAL GALVIS,JUANA CAROLINA"
    ],
    "3": [
        "MELO ARIAS,JORGE ALEJANDRO", "VIVAS MOLINA,CINDY JANETH", "PEREZ GONZALEZ RUBIO,KATHIA MILENA", 
        "ORBEGOZO CONTRERAS,DAMIAN", "RESTREPO CUBILLOS,NICOLAS"
    ],
    "4": [
        "RUBIO GOMEZ,JAIME ALBERTO", "HERRERA RIAÑO,ALVARO EMYIR", "RAMIREZ HENAO,JOHN ALEXANDER", 
        "MOSQUERA SOTO,SANDRA MILENA", "DURAN GONZALEZ,NILSON ADRIAN"
    ],
    "5": [
        "CACERES,DIANA PATRICIA", "ESPITIA SANCHEZ,WILFRED MAURICIO", "SUAREZ,JAVIER LEANDRO", 
        "ROJAS AMORTEGUI,JUAN MIGUEL", "GARCIA TORRES,NIDIA FARID"
    ],
    "6": [
        "MORENO DUARTE,RANDY ARIAN", "PARGA RAMIREZ,DIANA PAOLA", "HOYOS ARENAS,ANDREA DEL PILAR", 
        "CIFUENTES GARZON,CESAR AUGUSTO", "JUNCO,LUZ AYDEE"
    ],
    "7": [
        "GARAVITO MUÑOZ,CHRISTIAN ANDRES", "LLANOS SANDOVAL,ARNOLD ANTONIO", "HERNANDEZ RUIZ,GRACE PAOLA", 
        "ROJAS SUAREZ,MARIO FERNANDO", "SANTAMARIA ECHEVERRY,GUSTAVO ADOLFO"
    ]
};
...
function createWheel(selectedParticipant) {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            resultContainer.innerHTML = `
            <img src="avatars/${selectedParticipant.replace(/ /g, '_')}.png" alt="Avatar" class="avatar">
